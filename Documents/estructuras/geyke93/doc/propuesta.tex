...
\gantttitle{Setiembre y Octubre}{11} \\
\gantttitlelist{23,24,25,26,27,28,29,30,1,2,3}{1} \\
\ganttgroup{AES (Gabriel)}{1}{7} \\
\ganttgroup{RSA (Carla)}{1}{7}\\
\ganttgroup{Funciones hash (Gabriel y Carla)}{8}{11} \\
\end{ganttchart}
